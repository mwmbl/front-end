  ...
  function updateStats() {
    fetch("https://api.mwmbl.org/crawler/stats").then((result) => {
      result.json().then((stats2) => {
        ...
        const numUrlsInIndex = Object.values(stats2.urls_in_index_daily)[Object.keys(stats2.urls_in_index_daily).length - 1];
        ...
        const numDomainsInIndex = Object.values(stats2.domains_in_index_daily)[Object.keys(stats2.domains_in_index_daily).length - 1];
        ...
        const numResultsInIndex = Object.values(stats2.results_in_index_daily)[Object.keys(stats2.results_in_index_daily).length - 1];
        ...
        byUserChart.data.labels = Object.keys(stats2.top_users);
        byUserChart.data.datasets[0].data = Object.values(stats2.top_users);
        byUserChart.update();
        byDomainChart.data.labels = Object.keys(stats2.top_domains);
        byDomainChart.data.datasets[0].data = Object.values(stats2.top_domains);
        byDomainChart.update();
        numUrlsInIndexDailyChart.data.labels = Object.keys(stats2.urls_in_index_daily);
        numUrlsInIndexDailyChart.data.datasets[0].data = Object.values(stats2.urls_in_index_daily);
        numUrlsInIndexDailyChart.update();
        numDomainsInIndexDailyChart.data.labels = Object.keys(stats2.domains_in_index_daily);
        numDomainsInIndexDailyChart.data.datasets[0].data = Object.values(stats2.domains_in_index_daily);
        numDomainsInIndexDailyChart.update();
        numResultsInIndexDailyChart.data.labels = Object.keys(stats2.results_in_index_daily);
        numResultsInIndexDailyChart.data.datasets[0].data = Object.values(stats2.results_in_index_daily);
