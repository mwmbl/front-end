	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				destructive:
					'bg-destructive hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60 text-white hover:cursor-pointer',
				outline:
					'bg-background hover:cursor-pointer hover:bg-accent h hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 border',
				secondary:
